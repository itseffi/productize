...
9. **Save the file** — write to `.productize/tasks/<slug>/_idea.md`
...
9. Save the idea file.
   ...
   - Ask the user to confirm the filename using the interactive question tool:
     - "Save as `.productize/tasks/<slug>/_idea.md`? (A) Yes / (B) Different name"
   - Write the file to `.productize/tasks/<slug>/_idea.md`.
   - Confirm the file path to the user.
   - Remind the user that the next step is to create a PRD using `create-prd` from this idea.
...
- **Pipeline awareness** — The idea feeds into `create-prd`; focus on WHAT and WHY, not HOW
