---
name: productize-prototype-creation-from-image-descriptions-and-app-info
description: >-
  Prototype creation from image descriptions and app info. Use when the user needs a product
  workflow for design & prototyping related to prototype creation from image descriptions and
  app info. Trigger terms: pm, ux, prototyping, html, interaction-design.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Prototype creation from image descriptions and app info
...
- **Skill**: `prototype-creation-from-image-descriptions-and-app-info`
- **Lifecycle**: Design
- **Category**: Design
- **Primary artifact**: Prototype creation from image descriptions and app info UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **Prototype creation from image descriptions and app info**.
