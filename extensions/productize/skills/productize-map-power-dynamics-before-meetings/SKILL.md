---
name: productize-map-power-dynamics-before-meetings
description: >-
  Map power dynamics before meetings. Use when the user needs a product workflow for
  stakeholder management related to map power dynamics before meetings. Trigger terms:
  stakeholders, power-dynamics, meetings, communication.
---
...
- **Primary artifact**: Map power dynamics before meetings stakeholder narrative with audience, message, risks, asks, and follow-up owner

Use this skill to run the Productize prompt contract for **Map power dynamics before meetings**.
