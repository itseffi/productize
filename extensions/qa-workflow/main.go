...
const (
	extensionName    = "qa-workflow"
	extensionVersion = "0.1.0"

	reportMarker    = "<!-- productize-qa-workflow:qa-report -->"
	executionMarker = "<!-- productize-qa-workflow:qa-execution -->"
	...
	goalCommandWithObjective = "/goal Execute the Productize QA execution task end-to-end for this workflow: " +
...
func qaOutputPath(workflow string) string {
	return ".productize/tasks/" + strings.TrimSpace(workflow)
}
