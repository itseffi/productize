	...
	cases := []struct {
		...
		},
		{
			...
			payload: kinds.RunStartedPayload{
				...
				ReasoningEffort: "high",
				AccessMode:      "full",
				ArtifactsDir:    "/repo/.productize/runs/run-1",
				JobsTotal:       4,
			},
		},
		{
			...
			payload: kinds.RunCrashedPayload{
				...
				ResultPath:   "/repo/.productize/runs/run-1/result.json",
			},
		},
		{
			name: "run completed",
		...
		},
		{
			...
			payload: kinds.ReusableAgentLifecyclePayload{
				...
				MCPServers:        []string{"productize", "filesystem"},
				Resumed:           true,
				ToolCallID:        "tool-1",
				NestedDepth:       2,
				MaxNestedDepth:    3,
		...
		},
		{
			...
			payload: kinds.TaskFileUpdatedPayload{
				TasksDir:  "/repo/.productize/tasks/engine-kernel",
				TaskName:  "task_01.md",
				FilePath:  "/repo/.productize/tasks/engine-kernel/task_01.md",
				OldStatus: "pending",
				NewStatus: "completed",
			},
		},
		...
		},
		{
			...
			payload: kinds.ReviewStatusFinalizedPayload{
				ReviewsDir: "/repo/.productize/reviews/round-001",
		...
		},
		{
			...
			payload: kinds.ReviewIssueResolvedPayload{
				ReviewsDir:     "/repo/.productize/reviews/round-001",
				IssueID:        "001",
				FilePath:       "/repo/.productize/reviews/round-001/001.md",
				Provider:       "github",
				PR:             "123",
		...
		},
		{
			...
			payload: kinds.DiffBlock{
				FilePath: "pkg/productize/events/bus.go",
				Diff:     "@@ -1 +1 @@",
				OldText:  &oldText,
				NewText:  "new",
			},
