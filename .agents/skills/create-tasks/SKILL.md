...
2. Load context.
   - Read `_prd.md` and `_techspec.md` from `.productize/tasks/<name>/`.
   - Read existing ADRs from `.productize/tasks/<name>/adrs/` to understand the decision context behind requirements and design choices.
