---
name: productize-research-into-durable-competitive-moats
description: >-
  Research into durable competitive moats. Use when the user needs a product workflow for
  product strategy related to research into durable competitive moats. Trigger terms: moats,
  product-strategy, competitive-advantage, research-synthesis.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Research into durable competitive moats
...
- **Skill**: `research-into-durable-competitive-moats`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Research into durable competitive moats research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Research into durable competitive moats**.
