---
name: productize-feature-results-analysis-from-draft-to-final-report
description: >-
  Feature results analysis from draft to final report. Use when the user needs a product
  workflow for business analysis related to feature results analysis from draft to final
  report. Trigger terms: pm, business-analysis, experimentation, ab-testing, analysis,
  reporting.
---
...
- **Skill**: `feature-results-analysis-from-draft-to-final-report`
- **Lifecycle**: Launch & Learn
- **Category**: Analytics
- **Primary artifact**: Feature results readout with iterate, rollback, kill, or scale recommendation

Use this skill to run the Productize prompt contract for **Feature results analysis from draft to final report**.
