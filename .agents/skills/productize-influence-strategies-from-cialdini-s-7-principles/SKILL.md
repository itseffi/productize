---
name: productize-influence-strategies-from-cialdini-s-7-principles
description: >-
  Influence strategies from Cialdini's 7 principles. Use when the user needs a product
  workflow for stakeholder management related to influence strategies from cialdini's 7
  principles. Trigger terms: influence, cialdini, stakeholder-management.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Influence strategies from Cialdini's 7 principles
...
- **Skill**: `influence-strategies-from-cialdini-s-7-principles`
- **Lifecycle**: Align
- **Category**: Stakeholder Communication
- **Primary artifact**: Influence strategies from Cialdini's 7 principles stakeholder narrative with audience, message, risks, asks, and follow-up owner

Use this skill to run the Productize prompt contract for **Influence strategies from Cialdini's 7 principles**.
