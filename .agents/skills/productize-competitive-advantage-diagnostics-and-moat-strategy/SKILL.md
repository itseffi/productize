---
name: productize-competitive-advantage-diagnostics-and-moat-strategy
description: >-
  Competitive Advantage Diagnostics and Moat Strategy. Use when the user needs a product
  workflow for product strategy related to competitive advantage diagnostics and moat
  strategy. Trigger terms: strategy, competitive-advantage, moats, 7-powers.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Competitive Advantage Diagnostics and Moat Strategy
...
- **Skill**: `competitive-advantage-diagnostics-and-moat-strategy`
- **Lifecycle**: Strategize
- **Category**: Strategy
- **Primary artifact**: Competitive Advantage Diagnostics and Moat Strategy strategy memo with choices, tradeoffs, risks, and recommended next move

Use this skill to run the Productize prompt contract for **Competitive Advantage Diagnostics and Moat Strategy**.
