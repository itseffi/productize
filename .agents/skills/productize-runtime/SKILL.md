...
- **Skills-based.** Bundled skills (installed via `productize setup`) teach agents how to execute each workflow phase.
...
| `productize` | `/productize` | Learning how to use Productize | Executing workflow steps |
