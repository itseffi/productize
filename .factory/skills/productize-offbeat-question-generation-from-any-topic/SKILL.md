---
name: productize-offbeat-question-generation-from-any-topic
description: >-
  Offbeat question generation from any topic. Use when the user needs a product workflow for
  ideation & creativity related to offbeat question generation from any topic. Trigger terms:
  creativity, brainstorming, questions, perspective-shifting.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Offbeat question generation from any topic
...
- **Skill**: `offbeat-question-generation-from-any-topic`
- **Lifecycle**: Think
- **Category**: Discovery
- **Primary artifact**: Offbeat question generation from any topic product artifact with evidence, risks, recommendation, and next action

Use this skill to run the Productize prompt contract for **Offbeat question generation from any topic**.
