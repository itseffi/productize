---
name: productize-now-next-later-vision-roadmap-from-interview-synthesis
description: >-
  Now-Next-Later vision / roadmap from interview synthesis. Use when the user needs a product
  workflow for product strategy related to now-next-later vision / roadmap from interview
  synthesis. Trigger terms: interviews, research-synthesis, product-strategy, roadmapping,
  vision.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Now-Next-Later vision / roadmap from interview synthesis
...
- **Skill**: `now-next-later-vision-roadmap-from-interview-synthesis`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Now-Next-Later vision / roadmap from interview synthesis research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Now-Next-Later vision / roadmap from interview synthesis**.
