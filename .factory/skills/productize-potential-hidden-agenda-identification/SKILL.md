---
name: productize-potential-hidden-agenda-identification
description: >-
  Potential Hidden Agenda Identification. Use when the user needs a product workflow for
  stakeholder management related to potential hidden agenda identification. Trigger terms:
  stakeholders, analysis, organizational-politics, negotiation, stakeholder-management.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Potential Hidden Agenda Identification
...
- **Skill**: `potential-hidden-agenda-identification`
- **Lifecycle**: Align
- **Category**: Stakeholder Communication
- **Primary artifact**: Potential Hidden Agenda Identification stakeholder narrative with audience, message, risks, asks, and follow-up owner

Use this skill to run the Productize prompt contract for **Potential Hidden Agenda Identification**.
