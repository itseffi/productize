...
| `pkg/productize/events`          | Public event envelope, kind constants, and documented payload API          |
| `pkg/productize/runs`            | Public run reader library for list/open/replay/tail/watch flows            |
...
| `.productize/tasks`              | Default workflow artifact root (PRD, TechSpec, ADR, reviews)               |
...
3. **Forget `final-verify`** before marking tasks done
