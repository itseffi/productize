---
name: productize-product-design-analysis-from-context-and-screenshots
description: >-
  Product design analysis from context and screenshots. Use when the user needs a product
  workflow for design & prototyping related to product design analysis from context and
  screenshots. Trigger terms: pm, ux, design, critique, analysis.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Product design analysis from context and screenshots
...
- **Skill**: `product-design-analysis-from-context-and-screenshots`
- **Lifecycle**: Design
- **Category**: Design
- **Primary artifact**: Product design analysis from context and screenshots UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **Product design analysis from context and screenshots**.
