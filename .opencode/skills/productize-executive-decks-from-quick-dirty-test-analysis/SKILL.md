---
name: productize-executive-decks-from-quick-dirty-test-analysis
description: >-
  Executive decks from Quick Dirty Test analysis. Use when the user needs a product workflow
  for presentation & communication related to executive decks from quick dirty test analysis.
  Trigger terms: executive-communication, decision-support, hypothesis-testing, risk-analysis,
  quick-dirty-test.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Executive decks from Quick Dirty Test analysis
...
- **Skill**: `executive-decks-from-quick-dirty-test-analysis`
- **Lifecycle**: Design
- **Category**: Design
- **Primary artifact**: Executive decks from Quick Dirty Test analysis UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **Executive decks from Quick Dirty Test analysis**.
