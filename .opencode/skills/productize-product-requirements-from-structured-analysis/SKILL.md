---
name: productize-product-requirements-from-structured-analysis
description: >-
  Product requirements from structured analysis. Use when the user needs a product workflow
  for stakeholder management related to product requirements from structured analysis. Trigger
  terms: product-requirements, product-strategy, collaboration, systems-thinking.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Product requirements from structured analysis
...
- **Skill**: `product-requirements-from-structured-analysis`
- **Lifecycle**: Design
- **Category**: Delivery
- **Primary artifact**: Product requirements from structured analysis UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **Product requirements from structured analysis**.
