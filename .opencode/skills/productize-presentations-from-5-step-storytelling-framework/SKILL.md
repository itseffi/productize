---
name: productize-presentations-from-5-step-storytelling-framework
description: >-
  Presentations from 5-step storytelling framework. Use when the user needs a product workflow
  for presentation & communication related to presentations from 5-step storytelling
  framework. Trigger terms: presentations, storytelling, product-management, communication.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Presentations from 5-step storytelling framework
...
- **Skill**: `presentations-from-5-step-storytelling-framework`
- **Lifecycle**: Align
- **Category**: Stakeholder Communication
- **Primary artifact**: Presentations from 5-step storytelling framework stakeholder narrative with audience, message, risks, asks, and follow-up owner

Use this skill to run the Productize prompt contract for **Presentations from 5-step storytelling framework**.
