...
export interface HarnessOptions {
  ...
  /** Productize version reported by the simulated host. */
  productize_version?: string;
...
export class TestHarness {
  ...
  async initialize(identity: InitializeRequestIdentity): Promise<InitializeResponse> {
    return this.call("initialize", {
      ...
      productize_version: this.options.productize_version,
      extension: {
        ...identity,
...
function normalizeOptions(options: HarnessOptions): Required<HarnessOptions> {
  return {
    ...
    productize_version: options.productize_version ?? "dev",
