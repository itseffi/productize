...
name: design-system
description: >-
  Audit, document, or extend a design system. Use when checking for naming inconsistencies
  or hardcoded values across components, writing documentation for component variants, states,
