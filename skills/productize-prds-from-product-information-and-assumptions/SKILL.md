---
name: productize-prds-from-product-information-and-assumptions
description: >-
  PRDs from product information and assumptions. Use when the user needs a product workflow
  for business analysis related to prds from product information and assumptions. Trigger
  terms: pm, business-analysis, prd, requirements, documentation, impact-sizing.
---
...
- **Skill**: `prds-from-product-information-and-assumptions`
- **Lifecycle**: Discover
- **Category**: Delivery
- **Primary artifact**: PRDs from product information and assumptions research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **PRDs from product information and assumptions**.
