...
name: qa
description: >-
  QA gate for product behavior, acceptance criteria, evals, regression risk,
  evidence quality, and ship readiness. Use when a feature, fix, eval result, or
  release candidate needs quality verification before proceeding.
---
