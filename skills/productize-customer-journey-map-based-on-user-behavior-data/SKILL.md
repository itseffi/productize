---
name: productize-customer-journey-map-based-on-user-behavior-data
description: >-
  Customer journey map based on user behavior data. Use when the user needs a product workflow
  for business analysis related to customer journey map based on user behavior data. Trigger
  terms: pm, business-analysis, customer-journey, analytics, research.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Customer journey map based on user behavior data
...
- **Skill**: `customer-journey-map-based-on-user-behavior-data`
- **Lifecycle**: Measure
- **Category**: Analytics
- **Primary artifact**: Customer journey map based on user behavior data analytics diagnosis with metric readout, caveats, decision, and next instrumented step

Use this skill to run the Productize prompt contract for **Customer journey map based on user behavior data**.
