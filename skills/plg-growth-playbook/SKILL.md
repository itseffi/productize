---
name: plg-growth-playbook
description: >-
  Produce a practical PLG growth diagnosis for product-led B2B or self-serve products.
  Use when the user needs an integrated growth playbook covering bottlenecks, best-fit
  segment, aha moment, growth loops, experiments, PQLs, lifecycle triggers,
  pricing/packaging, growth pod sprint plan, and sustainability.
---
