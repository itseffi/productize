...
Use this reference to make interview transcript summaries include JTBD, satisfaction signals, quotes, and action items.
...
**Action Items**:
- [Date, Owner, Action -- e.g., "2025-01-15, Pawe Huryn, Follow up with customer about pricing"]
```
