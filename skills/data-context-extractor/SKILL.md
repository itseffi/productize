...
description: >-
  ...
  analysts. Use to bootstrap warehouse context, document schemas and metrics, or update an
  existing data skill with tables, terminology, filters, and query patterns.
---
