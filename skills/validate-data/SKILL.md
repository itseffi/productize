...
name: validate-data
description: >-
  QA an analysis before sharing, including methodology, accuracy, calculation, visualization, and
  bias checks. Use when reviewing analysis for stakeholders, spot-checking SQL results,
