---
name: strategic-decision-making-quality-review
description: >-
  Review the quality of a strategic product, innovation, or operating decision. Use when
  the user needs a decision-making artifact that separates facts, assumptions, alternatives,
  bias risks, evidence gaps, and decision safeguards before choosing.
---
