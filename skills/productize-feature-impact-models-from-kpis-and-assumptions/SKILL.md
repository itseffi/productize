---
name: productize-feature-impact-models-from-kpis-and-assumptions
description: >-
  Feature impact models from KPIs and assumptions. Use when the user needs a product workflow
  for business analysis related to feature impact models from kpis and assumptions. Trigger
  terms: pm, business-analysis, financial-modeling, kpi-impact.
---
...
- **Skill**: `feature-impact-models-from-kpis-and-assumptions`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Feature impact models from KPIs and assumptions research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Feature impact models from KPIs and assumptions**.
