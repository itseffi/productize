---
name: productize-problem-statement-framing-from-conversation-transcript
description: >-
  Problem statement framing from conversation transcript. Use when the user needs a product
  workflow for user research related to problem statement framing from conversation
  transcript. Trigger terms: user-research, problem-framing, transcripts.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Problem statement framing from conversation transcript
...
- **Skill**: `problem-statement-framing-from-conversation-transcript`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Problem statement framing from conversation transcript research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Problem statement framing from conversation transcript**.
