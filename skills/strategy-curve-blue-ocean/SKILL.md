---
name: strategy-curve-blue-ocean
description: >-
  Apply strategy curve and blue ocean analysis to compare an offer against competitors,
  identify factors of competition, plot as-is and to-be value curves, and define
  breakaway moves. Use for marketing strategy, category redesign, differentiation,
  noncustomer demand creation, and competitor value-curve analysis.
---
