...
name: operate
description: >-
  Productize operate playbook for the continuous production loop after a deploy.
  Use when a shipped product needs health monitoring, feedback intake, incident
  triage, metric review, support learning, fixes, and operating decisions.
---
