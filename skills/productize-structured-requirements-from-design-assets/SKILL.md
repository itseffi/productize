---
name: productize-structured-requirements-from-design-assets
description: >-
  Structured requirements from design assets. Use when the user needs a product workflow for
  business analysis related to structured requirements from design assets. Trigger terms: pm,
...
- **Skill**: `structured-requirements-from-design-assets`
- **Lifecycle**: Design
- **Category**: Delivery
- **Primary artifact**: Structured requirements from design assets UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **Structured requirements from design assets**.
