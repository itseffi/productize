...
name: docs
description: >-
  Documentation gate for README, guides, help content, API docs, release docs,
  migration notes, support content, and docs consistency after product or code
  changes. Use when shipped behavior and written guidance must match.
---
