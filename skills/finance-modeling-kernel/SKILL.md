...
description: >-
  Shared Productize Finance calculation and validation kernel for exact formulas,
  input normalization, assumption checks, units, warnings, and acceptance-tested
  finance math used by valuation, DCF, cost-of-capital, capital-structure, VC deal,
  and market-context skills.
---
