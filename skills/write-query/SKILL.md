...
name: write-query
description: >-
  Write optimized SQL for a specific dialect with best practices. Use when translating a natural
  language data need into SQL, building a multi-CTE query with joins and aggregations, optimizing
  a large partitioned-table query, or getting Snowflake, BigQuery, Postgres, or other dialect syntax.
---
