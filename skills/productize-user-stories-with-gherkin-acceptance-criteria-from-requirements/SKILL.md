...
Load `references/extended-reference.md` when the request mentions `3 cs`, `invest`, `user stories`, `conversation confirmation`. Use this reference material to sharpen this Productize skill.
