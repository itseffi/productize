---
name: productize-ux-terminology-improvements-in-product-requirements
description: >-
  UX terminology improvements in product requirements. Use when the user needs a product
  workflow for design & prototyping related to ux terminology improvements in product
  requirements. Trigger terms: ux, product-requirements, terminology, content-review.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# UX terminology improvements in product requirements
...
- **Skill**: `ux-terminology-improvements-in-product-requirements`
- **Lifecycle**: Design
- **Category**: Design
- **Primary artifact**: UX terminology improvements in product requirements UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **UX terminology improvements in product requirements**.
