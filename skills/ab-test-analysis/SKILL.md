...
description: >-
  A/B Test Analysis. Use when evaluating A/B test results, checking statistical
  significance, validating sample size, reading confidence intervals, or deciding whether
  to ship, extend, or stop an experiment.
---
