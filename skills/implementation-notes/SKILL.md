...
description: >-
  Running implementation-notes protocol for spec-driven builds. Use when the user
  asks the agent to maintain implementation-notes.md or implementation-notes.html
  with decisions, deviations, tradeoffs, open questions, and verification while
  implementing a feature, fix, or product slice.
---
