...
- A fork of [itseffi/productize](https://github.com/itseffi/productize)

## Getting Started

```bash
git clone git@github.com:<your-user>/productize.git
cd productize
git remote add upstream git@github.com:itseffi/productize.git
...
Productize bundles skills in the `skills/` directory. Each skill has:
