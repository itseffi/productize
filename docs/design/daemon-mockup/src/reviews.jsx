  ...
  it("rejects missing capabilities field", () => {`}
            ...
            <Section title="Discussion">
              ...
              <ChatBubble who="Rui" ts="2h ago" me>
                Agreed, this should be covered. @productize dispatch a fix, but keep the change scoped to the test file — don't touch the schema.
              </ChatBubble>
              <ChatBubble who="Productize" ts="2h ago">
