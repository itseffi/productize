/* global React */
// Fake data for Productize daemon prototype. All strings in the terse developer-first voice.
...
const RUNS = [
  {
    ...
    command: "productize tasks run user-auth --ide claude",
  },
  {
    id: "run_18b3",
    ...
    command: "productize tasks run manifest-v2 --ide claude",
  },
  {
    id: "run_3c2e",
    ...
    command: "productize tasks run skill-banner --ide gemini",
  },
  {
    id: "run_5d1a",
    workflow: "multi-repo",
    ...
    command: "productize tasks run multi-repo --ide codex --reasoning-effort high",
  },
  {
    id: "run_11a8",
    ...
    command: "productize tasks run stream-chunks --ide claude --stream",
  },
];

// Log samples for a running job
const SAMPLE_LOG = [
  { t: "12:04:11", lv: "info",  msg: "[productize] dispatching task_08 → claude / Sonnet 4.5 / medium" },
  { t: "12:04:11", lv: "debug", msg: "[prompt] workflow=user-auth task=task_08 tokens.in≈18.4k files.allowed=[packages/api, packages/auth]" },
  { t: "12:04:12", lv: "info",  msg: "[claude] opened session · worktree=feat/user-auth · skills=[execute-task, workflow-memory, final-verify]" },
  ...
  { t: "12:04:37", lv: "info",  msg: "[productize] verifying evidence via final-verify…" },
];
