    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ flex: 1, display: "grid", gridTemplateColumns: "280px 1fr", minHeight: 0 }}>
        <aside style={{ borderRight: "1px solid var(--border)", overflow: "auto", padding: "12px 10px", background: "var(--card)" }}>
          <div style={{ padding: "4px 10px 10px", fontSize: 10, fontFamily: "var(--font-mono)", color: "var(--muted-foreground)", textTransform: "uppercase", letterSpacing: "0.08em" }}>.productize/memory/{w.name}</div>
        ...
        <main style={{ overflow: "auto" }}>
          <div style={{ padding: "18px 28px 8px", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: "var(--font-mono)", fontSize: 12.5, color: "var(--foreground)" }}>.productize/memory/{w.name}/{sel}</span>
            <span style={{ flex: 1 }}/>
