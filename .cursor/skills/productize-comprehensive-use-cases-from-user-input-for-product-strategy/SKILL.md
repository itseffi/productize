---
name: productize-comprehensive-use-cases-from-user-input-for-product-strategy
description: >-
  Comprehensive use cases from user input for product strategy. Use when the user needs a
  product workflow for user research related to comprehensive use cases from user input for
  product strategy. Trigger terms: user-research, use-cases, product-strategy.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Comprehensive use cases from user input for product strategy
...
- **Skill**: `comprehensive-use-cases-from-user-input-for-product-strategy`
- **Lifecycle**: Strategize
- **Category**: Discovery
- **Primary artifact**: Comprehensive use cases from user input for product strategy strategy memo with choices, tradeoffs, risks, and recommended next move

Use this skill to run the Productize prompt contract for **Comprehensive use cases from user input for product strategy**.
