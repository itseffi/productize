---
name: productize-actionable-job-stories-from-interview-transcripts
description: >-
  Actionable job stories from interview transcripts. Use when the user needs a product
  workflow for user research related to actionable job stories from interview transcripts.
  Trigger terms: user-research, jtbd, interviews.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Actionable job stories from interview transcripts
...
- **Skill**: `actionable-job-stories-from-interview-transcripts`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Actionable job stories from interview transcripts research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Actionable job stories from interview transcripts**.
