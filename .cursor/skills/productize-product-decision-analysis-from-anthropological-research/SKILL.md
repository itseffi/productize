---
name: productize-product-decision-analysis-from-anthropological-research
description: >-
  Product decision analysis from anthropological research insights. Use when the user needs a
  product workflow for user research related to product decision analysis from anthropological
  research insights. Trigger terms: research, anthropology, product-strategy, user-personas.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Product decision analysis from anthropological research insights
...
- **Skill**: `product-decision-analysis-from-anthropological-research`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Product decision analysis from anthropological research insights research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Product decision analysis from anthropological research insights**.
