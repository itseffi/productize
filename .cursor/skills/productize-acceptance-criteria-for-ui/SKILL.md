---
name: productize-acceptance-criteria-for-ui
description: >-
  Acceptance criteria for UI. Use when the user needs a product workflow for technical related
  to acceptance criteria for ui. Trigger terms: quality-assurance, ui, acceptance-criteria,
...
- **Skill**: `acceptance-criteria-for-ui`
- **Lifecycle**: Design
- **Category**: Design
- **Primary artifact**: Acceptance criteria for UI UX/design review with findings, constraints, fixes, and acceptance checks

Use this skill to run the Productize prompt contract for **Acceptance criteria for UI**.
