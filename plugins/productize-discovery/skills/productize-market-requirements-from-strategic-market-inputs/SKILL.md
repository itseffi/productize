---
name: productize-market-requirements-from-strategic-market-inputs
description: >-
  Market requirements from strategic market inputs. Use when the user needs a product workflow
  for product strategy related to market requirements from strategic market inputs. Trigger
  terms: product-management, market-research, strategy, MRD.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Market requirements from strategic market inputs
...
- **Skill**: `market-requirements-from-strategic-market-inputs`
- **Lifecycle**: Strategize
- **Category**: Discovery
- **Primary artifact**: Market requirements from strategic market inputs strategy memo with choices, tradeoffs, risks, and recommended next move

Use this skill to run the Productize prompt contract for **Market requirements from strategic market inputs**.
