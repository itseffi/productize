---
name: productize-creative-solution-generation-from-de-bono-s-lateral-thinking
description: >-
  Creative solution generation from De Bono's lateral thinking methods. Use when the user
  needs a product workflow for ideation & creativity related to creative solution generation
  from de bono's lateral thinking methods. Trigger terms: ideation, creativity,
  lateral-thinking, de-bono, problem-solving, product-management.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Creative solution generation from De Bono's lateral thinking methods
...
- **Skill**: `creative-solution-generation-from-de-bono-s-lateral-thinking`
- **Lifecycle**: Think
- **Category**: Discovery
- **Primary artifact**: Creative solution generation from De Bono's lateral thinking methods product artifact with evidence, risks, recommendation, and next action

Use this skill to run the Productize prompt contract for **Creative solution generation from De Bono's lateral thinking methods**.
