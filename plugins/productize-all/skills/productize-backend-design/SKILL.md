---
name: productize-backend-design
description: >-
  Design backend architecture for implementation with API contracts, data model changes,
  service boundaries, security, and observability.
---
...
- **Primary artifact**: Backend Design UX/design review with findings, constraints, fixes, and acceptance checks
