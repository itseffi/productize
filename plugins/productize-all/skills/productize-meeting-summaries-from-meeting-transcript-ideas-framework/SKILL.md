---
name: productize-meeting-summaries-from-meeting-transcript-ideas-framework
description: >-
  Meeting summaries from meeting transcript (IDEAS framework). Use when the user needs a
  product workflow for presentation & communication related to meeting summaries from meeting
  transcript (ideas framework). Trigger terms: meetings, summarization, frameworks,
  note-taking.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Meeting summaries from meeting transcript (IDEAS framework)
...
- **Skill**: `meeting-summaries-from-meeting-transcript-ideas-framework`
- **Lifecycle**: Align
- **Category**: Operations
- **Primary artifact**: Meeting summaries from meeting transcript (IDEAS framework) stakeholder narrative with audience, message, risks, asks, and follow-up owner

Use this skill to run the Productize prompt contract for **Meeting summaries from meeting transcript (IDEAS framework)**.
