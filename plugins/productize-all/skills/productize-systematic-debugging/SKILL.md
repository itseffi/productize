---
name: productize-systematic-debugging
description: >-
  Four-phase debugging process: root cause first, then fix. Use when encountering bugs, test
...
- **Primary artifact**: Systematic Debugging AI-builder handoff with implementation scope, verification plan, and risks
