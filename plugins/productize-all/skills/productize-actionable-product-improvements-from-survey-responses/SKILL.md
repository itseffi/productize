---
name: productize-actionable-product-improvements-from-survey-responses
description: >-
  Actionable product improvements from survey responses. Use when the user needs a product
  workflow for user research related to actionable product improvements from survey responses.
  Trigger terms: user-research, surveys, insights.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Actionable product improvements from survey responses
...
- **Skill**: `actionable-product-improvements-from-survey-responses`
- **Lifecycle**: Discover
- **Category**: Discovery
- **Primary artifact**: Actionable product improvements from survey responses research brief with evidence, insight clusters, assumptions, and next validation steps

Use this skill to run the Productize prompt contract for **Actionable product improvements from survey responses**.
