---
name: productize-office-politics-with-machiavellian-strategy
description: >-
  Office politics with Machiavellian strategy. Use when the user needs a product workflow for
  stakeholder management related to office politics with machiavellian strategy. Trigger
  terms: stakeholders, office-politics, power-dynamics, influence.
---
<!-- AUTO-GENERATED from SKILL.md.tmpl - do not edit directly -->
<!-- Regenerate: npm run skills:generate -->

# Office politics with Machiavellian strategy
...
- **Skill**: `office-politics-with-machiavellian-strategy`
- **Lifecycle**: Strategize
- **Category**: Stakeholder Communication
- **Primary artifact**: Office politics with Machiavellian strategy strategy memo with choices, tradeoffs, risks, and recommended next move

Use this skill to run the Productize prompt contract for **Office politics with Machiavellian strategy**.
