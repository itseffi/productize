...
func TestSelfUpdaterClientDetectLatestReturnsReleaseInfo(t *testing.T) {
		...
		Source: fakeSelfupdateSource{
			releases: []selfupdate.SourceRelease{
				fakeSelfupdateRelease{
					id:          10,
					tagName:     "v1.2.3",
					name:        "Productize v1.2.3",
					url:         "https://github.com/itseffi/productize/releases/tag/v1.2.3",
					publishedAt: publishedAt,
					assets: []selfupdate.SourceAsset{
						fakeSelfupdateAsset{
							id:   1,
							name: "productize_linux_amd64.tar.gz",
							url:  "https://downloads.example.com/productize_linux_amd64.tar.gz",
						},
						fakeSelfupdateAsset{
							id:   2,
							name: "checksums.txt",
	...
	if got.URL != "https://github.com/itseffi/productize/releases/tag/v1.2.3" {
