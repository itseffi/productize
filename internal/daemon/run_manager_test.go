...
import (
	...
	runpkg "github.com/itseffi/productize/internal/core/run"
	workspacecfg "github.com/itseffi/productize/internal/core/workspace"
	"github.com/itseffi/productize/internal/store"
	"github.com/itseffi/productize/internal/store/globaldb"
	"github.com/itseffi/productize/internal/store/rundb"
...
func TestRunManagerStartRunSyncFailureMarksRunFailed(t *testing.T) {
	...
	workflowRoot := filepath.Join(env.workspaceRoot, ".productize", "tasks", "missing-workflow")
