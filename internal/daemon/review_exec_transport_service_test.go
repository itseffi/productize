...
func installSDKReviewProviderExtension(
	...
	extensionDir := filepath.Join(workspaceRoot, ".productize", "extensions", "sdk-review-ext")
	manifest := &extensions.Manifest{
		...
		Subprocess: &extensions.SubprocessConfig{
			...
			Env: map[string]string{
				...
				"PRODUCTIZE_SDK_REVIEW_PROVIDER": "sdk-review",
				"PRODUCTIZE_SDK_REVIEW_MODE":     "",
			},
		},
...
func sdkReviewExtensionBinary(t *testing.T) string {
	...
	sdkReviewExtensionBinaryOnce.Do(func() {
		...
		binaryDir, err := os.MkdirTemp("", "productize-sdk-review-extension-*")
		if err != nil {
