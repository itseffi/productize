...
func (m *Manager) initializeRequestForExtension(extension *RuntimeExtension) initializeRequest {
	...
	return initializeRequest{
		ProtocolVersion:           productizeProtocolVersion(),
		SupportedProtocolVersions: []string{productizeProtocolVersion()},
		ProductizeVersion:         strings.TrimSpace(version.Version),
...
func extensionEnvironment(manager *Manager, extension *RuntimeExtension) []string {
	...
	extra := map[string]string{
		"PRODUCTIZE_PROTOCOL_VERSION": productizeProtocolVersion(),
		"PRODUCTIZE_RUN_ID":           runID,
		"PRODUCTIZE_PARENT_RUN_ID":    parentRunID,
		"PRODUCTIZE_WORKSPACE_ROOT":   workspaceRoot,
		"PRODUCTIZE_EXTENSION_NAME":   extension.normalizedName(),
		"PRODUCTIZE_EXTENSION_SOURCE": string(extension.Ref.Source),
	}
...
func hostCapabilityEnvVar() string {
	return "PRODUCTIZE_HOST_CAPABILITY_" + "TOKEN"
}
