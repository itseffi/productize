...
func goSDKReviewProviderEntry(
	...
	return declaredReviewProviderForTest(
		...
		map[string]string{
			...
			"PRODUCTIZE_SDK_REVIEW_MODE":     mode,
			"PRODUCTIZE_SDK_REVIEW_PROVIDER": providerName,
		},
	)
}
...
func typeScriptReviewProviderEntry(
	...
	return declaredReviewProviderForTest(
		...
		entrypoint,
		map[string]string{
			"PRODUCTIZE_TS_RECORD_PATH": recordPath,
			"PRODUCTIZE_TS_REVIEW_MODE": mode,
		},
	)
}
...
func buildSDKReviewExtensionBinary(t *testing.T) string {
	...
	sdkReviewExtensionBuildOnce.Do(func() {
		dir, err := os.MkdirTemp("", "productize-sdk-review-extension-*")
		if err != nil {
...
func buildTypeScriptReviewProviderEntrypoint(t *testing.T) string {
	...
	tsReviewProviderBuildOnce.Do(func() {
		...
		targetDir, err := os.MkdirTemp("", "productize-ts-review-provider-*")
		if err != nil {
		...
		rewriteTemplateTokensForTest(t, targetDir, map[string]string{
			...
			"__PRODUCTIZE_MIN_VERSION__":        readSDKPackageVersion(t, repoRoot),
			"__PRODUCTIZE_EXTENSION_SDK_SPEC__": "file:" + sdkDir,
...
func stageTypeScriptSDKForReviewProvider(t *testing.T, repoRoot string) string {
	...
	stageRoot, err := os.MkdirTemp("", "productize-ts-review-sdk-*")
	if err != nil {
