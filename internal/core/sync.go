...
func openWorkflowGlobalDB(
	...
	if err != nil {
		return nil, globaldb.Workspace{}, fmt.Errorf("resolve productize home paths: %w", err)
	}
	if err := productizeconfig.EnsureHomeLayout(homePaths); err != nil {
		return nil, globaldb.Workspace{}, fmt.Errorf("ensure productize home layout: %w", err)
	}
