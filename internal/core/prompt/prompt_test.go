...
func TestBuildCodeReviewPromptUsesInstalledSkillsAndAvoidsLegacyDependencies(t *testing.T) {
	...
	promptText := buildCodeReviewPrompt(BatchParams{
		...
		Provider:   "coderabbit",
		PR:         "259",
		ReviewsDir: "/tmp/.productize/tasks/my-feature/reviews-001",
		AutoCommit: true,
		...
		BatchGroups: map[string][]model.IssueEntry{
			"internal/app/service.go": {
				{
					Name:     "issue_003.md",
					AbsPath:  "/tmp/.productize/tasks/my-feature/reviews-001/issue_003.md",
					CodeFile: "internal/app/service.go",
				},
				{
					Name:     "issue_004.md",
					AbsPath:  "/tmp/.productize/tasks/my-feature/reviews-001/issue_004.md",
					CodeFile: "internal/app/service.go",
				},
			},
		},
	...
	requiredSnippets := []string{
		...
		"Productize resolves provider threads after the batch succeeds.",
...
func TestBuildCodeReviewPromptRespectsManualCommitMode(t *testing.T) {
	...
	promptText := buildCodeReviewPrompt(BatchParams{
		...
		Provider:   "coderabbit",
		PR:         "260",
		ReviewsDir: "/tmp/.productize/tasks/my-feature/reviews-002",
		AutoCommit: false,
		Mode:       model.ExecutionModePRReview,
		BatchGroups: map[string][]model.IssueEntry{
			"internal/app/service.go": {
				{
					Name:     "issue_007.md",
					AbsPath:  "/tmp/.productize/tasks/my-feature/reviews-002/issue_007.md",
					CodeFile: "internal/app/service.go",
				},
			},
		},
...
func TestBuildPRDTaskPromptUsesInstalledSkillsAndLeavesOnlyTaskSpecificContext(t *testing.T) {
	...
	task := model.IssueEntry{
		Name:    "task_1.md",
		AbsPath: "/tmp/.productize/tasks/demo/task_1.md",
		Content: `---
status: pending
title: Example
type: backend
...
`,
	...
	promptText := buildPRDTaskPrompt(task, false, &WorkflowMemoryContext{
		Directory:    "/tmp/.productize/tasks/demo/memory",
		WorkflowPath: "/tmp/.productize/tasks/demo/memory/MEMORY.md",
		TaskPath:     "/tmp/.productize/tasks/demo/memory/task_1.md",
	})
	...
	requiredSnippets := []string{
		...
		"`final-verify`",
		"## Workflow Memory",
		"Shared workflow memory: `/tmp/.productize/tasks/demo/memory/MEMORY.md`",
		"Current task memory: `/tmp/.productize/tasks/demo/memory/task_1.md`",
		"## Task Files",
		"Task file: `/tmp/.productize/tasks/demo/task_1.md`",
		"Master tasks file: `/tmp/.productize/tasks/demo/_tasks.md`",
		"Automatic commits are disabled for this run (`--auto-commit=false`).",
		"<action_required>",
		"Begin work on **task_1.md** immediately",
		"do NOT ask the user",
		"<begin_now>",
		"Start the execute-task workflow on **task_1.md**",
	}
	for _, snippet := range requiredSnippets {
		if !strings.Contains(promptText, snippet) {
...
func TestBuildPRDTaskPromptRespectsAutoCommitFlag(t *testing.T) {
	...
	task := model.IssueEntry{
		Name:    "task_2.md",
		AbsPath: "/tmp/.productize/tasks/demo/task_2.md",
		Content: `---
status: pending
title: Example
type: bugfix
...
func TestBuildPRDTaskPromptIncludesActionDirectives(t *testing.T) {
	...
	task := model.IssueEntry{
		Name:    "task_42.md",
		AbsPath: "/tmp/.productize/tasks/auth/task_42.md",
		Content: `---
status: pending
...
func TestBuildPRDTaskPromptFlagsOversizedMemoryFiles(t *testing.T) {
	...
	task := model.IssueEntry{
		Name:    "task_3.md",
		AbsPath: "/tmp/.productize/tasks/demo/task_3.md",
		Content: `---
status: pending
title: Example
type: backend
...
`,
	...
	promptText := buildPRDTaskPrompt(task, false, &WorkflowMemoryContext{
		Directory:               "/tmp/.productize/tasks/demo/memory",
		WorkflowPath:            "/tmp/.productize/tasks/demo/memory/MEMORY.md",
		TaskPath:                "/tmp/.productize/tasks/demo/memory/task_3.md",
	...
	requiredSnippets := []string{
		...
		"Shared workflow memory is over its soft limit: `/tmp/.productize/tasks/demo/memory/MEMORY.md`",
		"Current task memory is over its soft limit: `/tmp/.productize/tasks/demo/memory/task_3.md`",
	}
	for _, snippet := range requiredSnippets {
		if !strings.Contains(promptText, snippet) {
			t.Fatalf("expected PRD prompt to include %q", snippet)
...
func TestBuildSystemPromptAddendumIncludesWorkflowMemoryOnlyForPRDTasks(t *testing.T) {
	...
	requiredSnippets := []string{
		"<workflow_memory>",
		"`workflow-memory`",
		"/tmp/.productize/tasks/demo/memory/MEMORY.md",
		"/tmp/.productize/tasks/demo/memory/task_1.md",
...
`,
	...
	reviewPrompt, err := Build(BatchParams{
		...
		PR:         "123",
		Round:      1,
		ReviewsDir: "/tmp/.productize/tasks/demo/reviews-001",
		BatchGroups: map[string][]model.IssueEntry{
			"internal/app/service.go": {{
				Name:     "issue_001.md",
				AbsPath:  "/tmp/.productize/tasks/demo/reviews-001/issue_001.md",
				CodeFile: "internal/app/service.go",
			}},
		},
	})
